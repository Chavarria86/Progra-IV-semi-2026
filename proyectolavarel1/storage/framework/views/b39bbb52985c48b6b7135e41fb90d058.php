...
<body>
    <div class="container">
        <div class="glass-card">
            ...
            <form action="<?php echo e(route('alumnos.store')); ?>" method="POST" class="form-grid">
                <?php echo csrf_field(); ?>
                
                <div class="form-group" style="animation-delay: 0.1s;">
                    <label for="codigo">Código Estudiantil</label>
                    <input type="text" id="codigo" name="codigo" placeholder="Ej: AL-2026" required value="<?php echo e(old('codigo')); ?>">
                </div>

                <div class="form-group full-width" style="animation-delay: 0.2s;">
                    <label for="nombre">Nombre Completo</label>
                    <input type="text" id="nombre" name="nombre" placeholder="Ej: José Chavarría" required value="<?php echo e(old('nombre')); ?>">
                </div>

                <div class="form-group" style="animation-delay: 0.3s;">
                    <label for="telefono">Teléfono</label>
                    <input type="text" id="telefono" name="telefono" placeholder="+503 7000-0000" value="<?php echo e(old('telefono')); ?>">
                </div>

                <div class="form-group" style="animation-delay: 0.4s;">
                    <label for="email">Correo Electrónico</label>
                    <input type="email" id="email" name="email" placeholder="correo@ejemplo.com" required value="<?php echo e(old('email')); ?>">
                </div>
                
                <div class="form-group full-width" style="animation-delay: 0.5s;">
                    <label for="direccion">Dirección Residencial</label>
                    <input type="text" id="direccion" name="direccion" placeholder="Ingresa la dirección completa" value="<?php echo e(old('direccion')); ?>">
                </div>
...
<?php /**PATH C:\Users\josec\OneDrive\Escritorio\Progra-IV-semi-2026\proyectolavarel1\resources\views/alumnos/create.blade.php ENDPATH**/ ?>